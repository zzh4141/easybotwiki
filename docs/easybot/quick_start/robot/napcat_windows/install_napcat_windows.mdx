...
| 镜像          | [点我下载](https://ghproxy.net/https://github.com/NapNeko/NapCatQQ/releases/download/v4.7.76/NapCat.Shell.zip) | 打不开 Github 可以下载             |
...
:::tip 快速登录
<Tabs>
  <TabItem value="Windows11" label="Windows11" default>
    launcher.bat 123456
  </TabItem>
  <TabItem value="Windows10" label="Windows10">
